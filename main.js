...
class InicioScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("fondoInicio","RSWallpaper.jpg");
    }
    ...
    create(){
        ...
        // Título del juego
        this.add.text(180,200,"TRIVIA REGULAR SHOW",{
            fontSize:"28px",
            color:"#ffffff"
...
class TriviaScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("fondoJuego","CasaParque.jpg");
    }
    ...
    create(){
        ...
        this.preguntas = [
            {pregunta:"¿Cuál es la edad de Mordecai y Rigby?", opciones:["20","27","23","25"], correcta:2},
            {pregunta:"¿Qué es el Martillo?", opciones:["Un Videojuego","Una Herramienta","Un Villano","Una Foto"], correcta:2},
            {pregunta:"¿Qué platillo debió comer Mordecai en menos de una hora para ganar una gorra de camionero?", opciones:["La Magnificarne","Omelette Extra Huevo Ordinario","Alitas del Infierno","El Sandwich de la Muerte"], correcta:1},
            {pregunta:"¿Cuál es el instrumento que sabe tocar Benson?", opciones:["Bateria","Guitarra Electrica","Bajo","Saxofón"], correcta:0},
            {pregunta:"¿Cuál fue el verdadero nombre de Skips?", opciones:["Jumps","Steps","Walks","Hops"], correcta:2},
            {pregunta:"¿De qué era el examen que debía aprobar el Caballo Fiestero?", opciones:["Matemáticas","Historia","Geografía","Fisica"], correcta:1},
            {pregunta:"¿Quien mas dice C=8?", opciones:["Mordecai","Mi tío John","Musculoso","Mi mami"], correcta:3},
            {pregunta:"¿Seguro, seguro qué tu mamasita sigue casada?", opciones:["Si","¿Qué?","¡Estamos perdiento el tiempo!","No, viejo"], correcta:2}
        ];
