...
preload(){
this.load.image("fondoInicio","FONDO2.jpeg");
...
preload(){
this.load.image("STARS","FONDO1.jpg");

this.load.image("FUEGO","DITTO.jpg");
this.load.image("XLR8","XLR8.jpg");
this.load.image("ULTRAT","ULTRAT.jpg");
this.load.image("DITTO","DITTO.jpg");
}
...
this.premios=["FUEGO","XLR8","ULTRAT","DITTO"];
this.resultados=[];
this.tarjetas=[];
this.descubiertas=0;
